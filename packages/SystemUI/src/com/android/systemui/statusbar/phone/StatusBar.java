...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    public void start() {
        ...
        mBlazeSettingsObserver.observe();
        mBlazeSettingsObserver.update();
    ...
    private BlazeSettingsObserver mBlazeSettingsObserver = new BlazeSettingsObserver(mHandler);

    private class BlazeSettingsObserver extends ContentObserver {
        BlazeSettingsObserver(Handler handler) {
            super(handler);
        }
